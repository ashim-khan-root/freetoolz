# 30-Day Blog Plan — freetoolz

Pick the next unwritten blog when user says "create blog". After writing, mark `[x]`.

---

| # | Topic | Tool Link | Written |
|---|-------|-----------|---------|
...
| 5 | Discount Calculator: Never Overpay Again — Smart Shopping Guide | discount-calculator | [x] |
...
| 21 | PoE Calculator: Power Over Ethernet for IP Cameras | poe-calculator | [ ] |
| 22 | UPS Sizing Guide: Choosing the Right UPS for Your Equipment | ups-calculator | [ ] |
| 23 | Field of View Calculator: Lens Selection for Security Cameras | fov-calculator | [ ] |
| 24 | Subnet Calculator: Understanding IP Subnetting | subnet-calculator | [ ] |
