...
Plan and design surveillance systems with our suite of CCTV calculators. From storage and bandwidth planning to power budgets and camera placement, these tools help security professionals make informed decisions.

## What You Can Calculate

- **RAID Storage** — usable capacity for NVRs with RAID 0/1/5/6/10
- **CCTV Storage** — recording days and HDD size based on cameras, resolution, and retention
- **Network Bandwidth** — total bandwidth required for IP camera systems
